...
class Plugin
{
	...
	public static function getRequirements(GenericEvent $event)
	{
		...
		$loader->add_requirement('get_pleskautomation_info_from_domain', '/../vendor/detain/pleskautomation-webhosting/src/get_pleskautomation_info_from_domain.php');
		$loader->add_requirement('get_webhosting_ppa_instance', '/../vendor/detain/pleskautomation-webhosting/src/get_webhosting_ppa_instance.php');
	}
